...
if __name__ == "__main__":
    ...
    start_link = start_link2#初始拓扑

    thread_list = []
    df = pd.read_csv('/home/wspn02/mega/WGQ/convergence_test/144/link_144.csv')
    ...
    df = df2
    # 获取 name 列的所有数据
    name_list = df['name'].tolist() + ['MEO-1', 'MEO-2', 'MEO-3', 'MEO-4', 'MEO-5', 'MEO-6', 'MEO-7', 'MEO-8']
