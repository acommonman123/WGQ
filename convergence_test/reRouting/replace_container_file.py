...
if __name__ == "__main__":
    ...
    for container in name_list:
        os.system("docker cp /home/wspn02/mega/WGQ/convergence_test/reRouting/socket_recv_LEO.py " + container + ":/")
        os.system("docker cp /home/wspn02/mega/WGQ/convergence_test/reRouting/incluster_inform.py " + container + ":/")
        os.system("docker cp /home/wspn02/mega/WGQ/convergence_test/hello.py " + container + ":/")
    ...
    for container in MEO_IDs:
        os.system("docker cp /home/wspn02/mega/WGQ/convergence_test/reRouting/socket_recv_MEO.py " + container + ":/")
