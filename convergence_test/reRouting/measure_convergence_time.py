...
def get_convergence_time():
    ...
    lock.release()
    result = cursor.fetchall()
    start_time = float(result[-1][0])
    with open('/home/wspn02/mega/WGQ/convergence_test/time.txt','r') as f:
        lines = f.readlines()
...
def cluster_routing():
    os.system('~/anaconda3/envs/be2/bin/python /home/wspn02/mega/WGQ/convergence_test/reRouting/cluster_routing.py')
