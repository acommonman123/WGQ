...
def publisher():
    ...
    message = "links are created"
    # 发送消息到 Redis 的 'working_be'
    #message = "Hello, Redis!"
    print(f"Publishing: {message}")
    r.publish('routing', message)
...
if __name__ == "__main__":
    ...
    added_links = [{'sat1': 'WALKERdgm-3801', 'sat2': 'WALKERdgm-3101'}, {'sat1': 'WALKERdgm-3806', 'sat2': 'WALKERdgm-3106'}, {'sat1': 'WALKERdgm-3811', 'sat2': 'WALKERdgm-3111'}]
